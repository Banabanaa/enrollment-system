...
class RStudentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('registrar.manage.student', compact('students'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('registrar.manage.student')->with('success', 'Student updated successfully.');
    }
    ...
    {
        $student->delete();
        return redirect()->route('registrar.manage.student')->with('success', 'Student deleted successfully.');
    }
}
