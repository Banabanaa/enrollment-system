...
class DDepartmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('department.manage.department', compact('departments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('department.manage.department')->with('success', 'Department added successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('department.manage.department')->with('success', 'Department updated successfully.');
    }
    ...
    {
        $department->delete();
        return redirect()->route('department.manage.department')->with('success', 'Department deleted successfully.');
    }
}
