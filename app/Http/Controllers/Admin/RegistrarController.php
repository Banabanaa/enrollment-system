...
class RegistrarController extends Controller
{
    public function index()
    {
        ...
        return view('admin.manage.registrar', compact('registrars'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.manage.registrar')->with('success', 'Registrar added successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.manage.registrar')->with('success', 'Registrar updated successfully.');
    }
    ...
    {
        $registrar->delete();
        return redirect()->route('admin.manage.registrar')->with('success', 'Registrar deleted successfully.');
    }
}
