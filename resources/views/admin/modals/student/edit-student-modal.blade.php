        ...
        <form action="{{ route('admin.manage.student.update', $student->id) }}" method="POST">
            ...
            <div class="modal-body grid grid-cols-2 gap-6">
                ...
                <div class="col-span-2 sm:col-span-1">
                    <label for="student_name" class="form-label text-sm text-dark">Student Name</label>
                    <input type="text" class="form-control w-full px-3 py-2 bg-input rounded-lg text-sm border-0 focus:outline-none focus:ring-2 focus:ring-primary" name="student_name" value="{{ $student->student_name }}" required>
                </div>
