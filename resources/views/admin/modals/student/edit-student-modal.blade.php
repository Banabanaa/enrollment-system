        ...
        <form action="{{ route('department.manage.department.update', $department->id) }}" method="POST">
            ...
            <div class="modal-body grid grid-cols-2 gap-6">
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <input type="text" class="form-control w-full px-3 py-2 bg-input rounded-lg text-sm border-0 focus:outline-none focus:ring-2 focus:ring-primary" name="department_name" value="{{ $department->department_name }}" required>
                </div>
