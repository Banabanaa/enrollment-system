...
<div class="container mx-auto p-6">
    ...
    <ol class="breadcrumb mb-4 text-justify">
        <li class="breadcrumb-item active">
            Student Use of the Enrollment System for Computer Science and Information Technology Courses at CvSU-Bacoor City Campus
        </li>
    </ol>
    ...
    <div class="mt-4 text-justify">
        ...
        <h2 class="mt-4">2. Purpose of the System</h2>
        ...
        <h2 class="mt-4">3. User Accounts</h2>
        <h4 class="mt-2">Account Creation</h4>
        ...
        <h4 class="mt-2">Account Security</h4>
        ...
        <h4 class="mt-2">Account Usage</h4>
        ...
        <h4 class="mt-2">System Integrity</h4>
        <p>You agree not to interfere with the proper functioning of the System.</p>

        <h2 class="mt-4">5. Data Privacy and Security</h2>
        <h4 class="mt-2">Data Collection</h4>
        ...
        <h4 class="mt-2">Data Security</h4>
        ...
        <p>Please refer to the Institution’s Privacy Policy, available at [link to Privacy Policy], for more information about how your data is collected, used, and protected.</p>

        <h2 class="mt-4">6. Academic Information and Accuracy</h2>
        <h4 class="mt-2">Accuracy of Information</h4>
        <p>You are responsible for ensuring the accuracy of the information you provide in the System.</p>

        <h4 class="mt-2">Grade Information</h4>
        <p>The grades displayed on the System are subject to final review by the Institution and may be updated or corrected.</p>

        <h4 class="mt-2">Transcript Information</h4>
        ...
        <h2 class="mt-4">8. System Availability and Maintenance</h2>
        <h4 class="mt-2">Service Uptime</h4>
        ...
        <h4 class="mt-2">No Guarantee</h4>
        <p>The Institution does not guarantee uninterrupted or error-free access to the System.</p>

        <h2 class="mt-4">9. Changes to the Terms</h2>
        <h4 class="mt-2">Updates</h4>
        ...
        <h4 class="mt-2">Continued Use</h4>
        ...
        <h2 class="mt-4">11. Disclaimer of Warranties</h2>
        ...
        <h2 class="mt-4">15. Contact Information</h2>
        <p>If you have any questions about these Terms, please contact:</p>
        <p><strong>Cavite State University - Bacoor Campus</strong></p>
        <p>Email: cvsubacoor@cvsu.edu.ph</p>
        <p>Phone: (046) 476-5029</p>

        <h2 class="mt-4">16. Entire Agreement</h2>
        ...
        <h2 class="mt-4">17. Severability</h2>
