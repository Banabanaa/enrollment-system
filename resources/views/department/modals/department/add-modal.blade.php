...
<div id="addDepartmentModal" class="modal-overlay hidden scrollbar-thin scrollbar-thumb-green-500 scrollbar-track-gray-100">
    <div class="modal-container">
        <!-- Modal Header -->
        <div class="modal-header border-b border-border-color mb-6 flex justify-between items-center">
            <h2 class="modal-title text-primary font-semibold text-lg">Add Department</h2>
            <button type="button" class="modal-close text-gray-600 hover:text-gray-900" onclick="toggleModal('addDepartmentModal')">
            ...
            <form action="{{ route('department.manage.department.store') }}" method="POST">
                ...
                <div class="space-y-6 pr-5 pl-3">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="department_name" class="form-label text-sm text-dark">Department Name</label>
                            <input type="text" class="form-control w-full px-3 py-2 bg-input rounded-lg text-sm border-0 focus:outline-none focus:ring-2 focus:ring-primary" name="department_name" placeholder="Enter Department Name" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer mt-8 flex justify-end space-x-4 pr-5">
                    ...
                    <button type="submit" class="text-white px-10 h-8 rounded-lg bg-primary hover:bg-lime-green" data-bs-dismiss="modal">Add Department</button>
                </div>
            </form>
        </div>
    </div>
