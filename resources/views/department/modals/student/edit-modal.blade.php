...
<div id="editStudentModal-{{ $student->id }}" class="modal-overlay hidden scrollbar-thin scrollbar-thumb-green-500 scrollbar-track-gray-100">
    ...
    <input type="text" class="form-control w-full px-3 py-2 bg-input rounded-lg text-sm border-0 focus:outline-none focus:ring-2 focus:ring-primary" name="student_number" value="{{ $student->student_number }}" required readonly>
</div>
                        ...
                        <div>
                            ...
                            <select class="form-select w-full px-3 py-2 bg-input rounded-lg text-sm border-0 focus:outline-none focus:ring-2 focus:ring-primary" name="sex">
                                ...
                                <option value="other" @if($student->sex == 'other') selected @endif>Other</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select class="form-select w-full px-3 py-2 bg-input rounded-lg text-sm border-0 focus:outline-none focus:ring-2 focus:ring-primary" name="year">
                                <option value="1" @if($student->year == '1st') selected @endif>1</option>
                                <option value="2" @if($student->year == '2nd') selected @endif>2</option>
                                <option value="3" @if($student->year == '3rd') selected @endif>3</option>
                                <option value="4" @if($student->year == '4th') selected @endif>4</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select class="form-select w-full px-3 py-2 bg-input rounded-lg text-sm border-0 focus:outline-none focus:ring-2 focus:ring-primary" name="section">
                                <option value="1" @if($student->section == '1') selected @endif>1</option>
                                <option value="2" @if($student->section == '2') selected @endif>2</option>
                                <option value="3" @if($student->section == '3') selected @endif>3</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select class="form-select w-full px-3 py-2 bg-input rounded-lg text-sm border-0 focus:outline-none focus:ring-2 focus:ring-primary" name="classification">
                                <option value="regular" @if($student->classification == 'regular') selected @endif>Regular</option>
                                <option value="irregular" @if($student->classification == 'irregular') selected @endif>Irregular</option>
                                <option value="transferee" @if($student->classification == 'transferee') selected @endif>Transferee</option>
                                <option value="returnee" @if($student->classification == 'returnee') selected @endif>Returnee</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <select class="form-select w-full px-3 py-2 bg-input rounded-lg text-sm border-0 focus:outline-none focus:ring-2 focus:ring-primary" name="program_id">
                                <option value="Bachelor of Science in Computer Science" @if($student->program_id == 'Bachelor of Science in Computer Science') selected @endif>Bachelor of Science in Computer Science</option>
                                <option value="Bachelor of Information Technology" @if($student->program_id == 'Bachelor of Information Technology') selected @endif>Bachelor of Information Technology</option>
                            </select>
                        </div>
                    </div>
                </div>
