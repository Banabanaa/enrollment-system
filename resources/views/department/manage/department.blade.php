...
@php
    $title = 'CVSU - Department - Dep Accounts';
@endphp
@section('content')
...
<div class="p-5 bg-light rounded-2xl shadow-big w-full mx-auto mb-8">
    ...
    <div class="flex justify-between items-center mb-4">
        <div class="flex items-center space-x-4">
            <h2 class="font-table-header text-xl font-bold text-primary">Departments Table</h2>
        </div>
        <div class="flex space-x-2">
            <button
                ...
                onclick="toggleModal('addDepartmentModal')">
            ...
            <tbody>
                @foreach($departments as $department)
                    <tr class="hover:bg-gray-100 border-b border-border-color">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">{{ $department->first_name }}</td>
                        <td class="px-6 py-4 text-sm text-gray-600">{{ $department->last_name }}</td>
